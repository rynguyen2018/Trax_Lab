...
E14_Neg_significant <- subset(id,E14.log.2<(mean(E14.log.2,na.rm=T)-abs(2*E14_standev))) #-2 sigma
...
#print(standard_dev)
Plus_list= list(E14_Plus_significant,SPB74_Plus_significant,Virido_Plus_significant,J1074_Plus_significant,AA4_Plus_significant)
lenA<-length(E14_Plus_significant)
...
money_shot= Reduce(intersect,list(Plus_list[[1]],Plus_list[[2]], Plus_list[[3]], Plus_list[[4]], Plus_list[[5]]))
