...
theta2<- c(beta_AdpA= 1, gamma_AdpA=2, k1_AdpA= 3, k2_AdpA= 90,  sigma_AdpA=3.5*10^-3, n1=1.2, n2=5, gamma_BldA= 2, k1_BldA=2, sigma_BldA= 0.3,p= 2, sigma_adpAchange= 0.1, sigma_bldAchange= 0.3, shape_parameter= 3)
...
mcmcTrace<- mclapply(X= vec[1:2], FUN=function(theta){mcmcMH(posterior = logPosteriorMH, # posterior distribution
...
numIterations = 10000)}, mc.cores=2) # number of iterations 
